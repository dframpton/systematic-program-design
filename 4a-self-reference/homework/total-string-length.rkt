...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname total-string-length) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))

;; total-string-length.rkt
...
(check-expect (total-string-length (cons "hello" empty)) (+ 5 0))
(check-expect (total-string-length (cons "hello" (cons "goodbye" empty))) (+ 7 (+ 5 0)))
