...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname lookup-in-list) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
(check-expect (lookup empty 5) false)
(check-expect (lookup (list (make-account 1 "abc") (make-account 4 "dcj") (make-account 3 "ilk")) 1)
              "abc")
(check-expect (lookup (list (make-account 1 "abc") (make-account 4 "dcj") (make-account 3 "ilk")) 3)
              "ilk")
(check-expect (lookup (list (make-account 1 "abc") (make-account 4 "dcj") (make-account 3 "ilk")) 2)
              false)
