...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname naturals) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
(define (fn-for-natural n)
  (cond [(zero? n) (...)]
        [else
         (... n   ; template rules don't include n, but it seems to be used a lot
                  ; so it's added here.
...
;; Natural -> Natural
;; produce the sum of all the naturals in [0, n]
