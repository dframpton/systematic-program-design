...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname compare-images) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
