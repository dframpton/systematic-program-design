...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname pluralize-stubs) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
