...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname encapsulate-total-area) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))

;; encapsulate-total-area.rkt
