...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname prefix-equal) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
;the first list match the elements of the second list 1 for 1, and the first list
;is at least as long as the second. If the preceding is true the second list may 
...
(check-expect (prefix=? empty (list "y")) true)
